...
const canciones = [
  { nombre: "De Que Fa Gust La Lluna", archivo: "Conte1.mp3" },
  { nombre: "Peix Irisat", archivo: "Conte2.mp3" },
  { nombre: "La Vaco", archivo: "Conte3.mp3" }
];
...
listadoMusica.onclick = (e) => {
  ...
  reproduccionActual("Reproduciendo: " + canciones[itemClick.id].nombre);
...
function loadMusic(ruta) {
  ...
  var index = indiceActual[0] = canciones.findIndex(cancion => cancion.archivo === ruta);
  removeActive();
